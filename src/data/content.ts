...
export const tagline = {
  en: "Backend Developer turning ideas into production-ready APIs.",
  vi: "Backend Developer biến ý tưởng thành những REST API sẵn-sàng-cho-production.",
};
...
export const projects = [
  {
    ...
    highlights: {
      en: [
        ...
        "Notification scheduler, global exception handler, data initializer",
...
export const awards = [
  {
    ...
    issuer: "UIT",
    period: {
      en: "Semester 2, 2024–2025",
      vi: "Học kỳ 2, 2024–2025",
    },
  },
  {
    title: {
  ...
  },
  {
    ...
    issuer: "UIT",
    period: {
      en: "Semester 2, 2023–2024",
      vi: "Học kỳ 2, 2023–2024",
    },
  },
];
...
export const ui = {
  ...
  sections: {
    ...
    contact: { en: "Get in touch", vi: "Liên hệ" },
  },
  labels: {
    downloadCv: { en: "Download CV", vi: "Tải CV" },
    viewCode: { en: "View source", vi: "Xem mã nguồn" },
